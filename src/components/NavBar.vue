  ...
  <nav class="navbar navbar-expand-lg custom-navbar px-4 py-2">
    ...
    <div class="collapse navbar-collapse" id="navbarContent">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li v-else class="nav-item dropdown d-flex align-items-center gap-3">
          <div>
            <a
...
<style scoped>
  .custom-navbar {
    ...
    box-shadow: 0 2px 10px rgba(245, 170, 41, 0.984);
  ...
  box-shadow: 0 2px 10px rgb(250, 152, 59);
  border-radius: 0 0 12px 12px;
  position: sticky;
  top: 0;
  z-index: 1000;
